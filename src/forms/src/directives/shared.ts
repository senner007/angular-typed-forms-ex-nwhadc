...
function registerOnValidatorChange<V>(
 ...
 */
export function setUpDisabledChangeHandler(
  control: FormControl,
  dir: NgControl
): void {
...
export function setUpValidators(
  ...
  if (dir.validator !== null) {
    control.setValidators(
      mergeValidators<ValidatorFn>(validators, dir.validator)
    );
  ...
  registerOnValidatorChange<AsyncValidatorFn>(
    dir._rawAsyncValidators,
    onValidatorChange
  );
}
...
export function isPropertyUpdated(
