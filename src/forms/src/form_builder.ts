...
import {AbstractControl, AbstractControlOptions, FormArray, FormControl, FormControlOptions, FormGroup, FormHooks, FormState} from './model';
 ...
 */
 ...
 export class FormBuilder {
   ...
   control<T>(formState: T|FormState<T>, opts: FormControlOptions&{initialValueIsDefault: true}):
       FormControl<T>;
    ...
    * such functions, or an `FormControlOptions` object that contains
